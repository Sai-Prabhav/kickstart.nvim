...
-- Set folding by syntax for TeX files
vim.api.nvim_create_autocmd('FileType', {
  pattern = 'tex',
  callback = function()
    vim.opt_local.foldmethod = 'indent'
    vim.opt_local.foldlevel = 99 -- Keeps folds open by default
  end,
})
--
...
require('lazy').setup({
  ...
  -- NOTE: Plugins can also be add for most of the thingsed by using a table,
